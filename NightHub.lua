	...
	function CheckMoon()
		...
		if moonreal == moon5 or moonreal == moon4 then
			...
			elseif moonreal == moon4 then
				cofullmoonkothangbeo = "Next Light"
			end
		end
...
CamShake:Stop()
    ...
    function function8()
        ...
        if CheckMoon() == "Next Light" and ao < 12 then
            return tostring(function6()) .. " ( Will Full Moon In " .. math.floor(18 - ao) .. " Minutes )"
        elseif CheckMoon() == "Next Light" and ao > 12 then
...
local Window = OrionLib:MakeWindow({Name = "Light Hub", HidePremium = false, IntroText = "LightHub Library", SaveConfig = true, ConfigFolder = "Light Hub"})
...
W:AddLabel("Script By VuTruong")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Welcome To Light Hub")
W:AddLabel("[+] Use Arceu X For The Best Experience")
W:AddLabel("[+] We Bring the Best Script to Everyone")
...
local locallv = W:AddLabel("Level")
    ...
    local    MidLightBlade =            W:AddLabel("❌ : MidLight Blade")

...
local F = Library:AddTab("Farm Level Fast","rbxassetid://10723407389")
...
--------------------------------------------------------------------------------------------------------
F:AddSeperator("Kaitun")

    F:AddToggle("Auto Farm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
        StopTween(_G.AutoFarm)
    end)
    
if World1 then
    F:AddToggle("Auto Farm Fast (Farm Lv.1-300)",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
...
F:AddToggle("Auto Kaitun (Farm Lv.1-2550)",false,function(value)
       _G.AutoFarm = value
